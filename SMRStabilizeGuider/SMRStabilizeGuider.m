...
// 转自:http://www.cocoachina.com/ios/20180309/22517.html
#import "SMRStabilizeGuider.h"
#import <objc/runtime.h>
#import <JavaScriptCore/JavaScriptCore.h>
#import <Aspects/Aspects.h>

@implementation SMRStabilizeGuider

+ (instancetype)sharedInstance {
    static SMRStabilizeGuider *_stabilizeGuider = nil;
    static dispatch_once_t stabilizeGuiderOnceToken;
    dispatch_once(&stabilizeGuiderOnceToken, ^{
        _stabilizeGuider = [[self alloc] init];
    });
    return _stabilizeGuider;
}
